              ...
              <div className="row">
                <div className="col-md-4">
                  <img
                    ...
                    src={data?.campaign?.logo?.startsWith('data:') ? data?.campaign?.logo : `${process.env.REACT_APP_API}/uploads/${data?.campaign?.logo}`}
                ...
                <div className="col-md-8 p-0">
                  <img
                    className={'table-image'}
                    src={data?.campaign?.cover?.startsWith('data:') ? data?.campaign?.cover : `${process.env.REACT_APP_API}/uploads/${data?.campaign?.cover}`}
                    alt={data.campaign?.name}
                    width="100%"
                    height="68px"
