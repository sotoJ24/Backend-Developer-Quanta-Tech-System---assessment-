        ...
        <div className="container">
          <div className={'nft-confirmation'}>
            ...
            <div className={'nft-preview'}>
              ...
              {typeConfirmation === "update" ? <img src={nftData?.image.startsWith('data:') ? nftData?.image : `${process.env.REACT_APP_API}/uploads/` + nftData?.image} alt={'current nft'} /> :
                <img src={typeof nftData.image === 'string' && nftData.image.startsWith('data:') ? nftData.image : URL.createObjectURL(nftData.image)} alt={'preview of your NFT'} />
              }
