        ...
        <div className="table-image-wrapper">
          {row?.nft?.image ? (
            <img
              ...
              src={row?.nft?.image.startsWith('data:') ? row?.nft?.image : `${process.env.REACT_APP_API}/uploads/${row?.nft?.image}`}
              alt={row?.nft?.name}
              style={{cursor:'pointer'}}
              onClick={() => {
                setShowImage(true)
                setImgSrc(row?.nft?.image.startsWith('data:') ? row?.nft?.image : `${process.env.REACT_APP_API}/uploads/${row?.nft?.image}`)
              }}
            />
          ) : (
      ...
      >
        <div className={'modal-body-main'}>
          <div className={'single-info'}>
            <p>Campaign Logo:</p>
            <img src={viewCampaignData.logo?.startsWith('data:') ? viewCampaignData.logo : `${process.env.REACT_APP_API}/uploads/${viewCampaignData.logo}`} alt={'logo'} />
          </div>
          <div className={'single-info'}>
            <p>Campaign Banner:</p>
            <img src={viewCampaignData.cover?.startsWith('data:') ? viewCampaignData.cover : `${process.env.REACT_APP_API}/uploads/${viewCampaignData.cover}`} alt={'cover'} />
          </div>
          <div className={'single-info'}>
            <p>Campaign name:</p>
          ...
          <div className={'single-info'}>
            <p>NFT Image:</p>
            <img src={viewNFTData?.image?.startsWith('data:') ? viewNFTData?.image : `${process.env.REACT_APP_API}/uploads/${viewNFTData?.image}`} alt={'logo'} />
          </div>
          <div className={'single-info'}>
            <p>NFT Description:</p>
