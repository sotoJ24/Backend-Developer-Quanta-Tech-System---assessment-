        ...
        {(!user.kyb_passed && !user.is_superadmin) && (
          <div className="col-12 errors">
            <div className="container text-black">
              You must validate your KYB to submit campaign <a className={'text-black'} href={'/dashboard'} style={{ fontWeight: 'bold' }} >by clicking here</a>, no need to do it now because this is just a test project.
            </div>
          </div>
        )}
