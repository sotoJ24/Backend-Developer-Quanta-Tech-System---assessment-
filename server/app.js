...
// Mock endpoint for campaign slug validation
app.get('/campaigns/slugCheck', (req, res) => {
  const { slug } = req.query;
  console.log(`Campaign slug check request: ${slug}`);
  
  // For testing: simulate that slug is always available
